...
public final class Often {
    ...
    public static final String host = "info.sporttery.cn";      //竞彩host
    ...
    public static String stringDecode(String s, String codingCharsetName, String decodeCharsetName)
    ...
    public static String dateLongTime(Date date) {
    ...
    public static String dateSimpleTime() {
        Date date = new Date();
     ...
     * @return HHmmss
     */
    public static String timeNum(Date date) {
    ...
    public static String weekDayString(Date date){
        GregorianCalendar calendar = new GregorianCalendar();
        calendar.setTime(date);
        int d= calendar.get(GregorianCalendar.DAY_OF_WEEK) - 1;
        String week="";
        switch (d){
            case 1:
                week = "周一";
     ...
     * @param parameter
     * @param session
     * @param streamCharsetName
     * @param readTimeOut 读取数据超时，单位毫秒
     * @return
     */
    public static String http(String url, String parameter, boolean session, String streamCharsetName, int readTimeOut) {
    	HttpURLConnection httpConnection = httpConnection(url);
    	if (httpConnection == null)
    		return null;
    ...
    public static String httpPost(String url, String parameter, boolean session, String streamCharsetName, int readTimeOut) {
    ...
    public static String http(HttpURLConnection con, String parameter, boolean session, String streamCharsetName) {
        ...
        try {
            ...
            logger.error("<http> ERROR:! url=" + con.getURL(), e);
            return null;
        } finally {
        	con.disconnect();
        }
...
//    /**
//     * 通过httpclient发送post，参数会utf-8转码
//     * @param reUrl
//     * @param ParamMap
//     * @return
//     */
//    public static String httpUTF8Post(String reUrl, Map<String, String> ParamMap) {
//    	PostMethod postMethod = null;
//    	try {
//    	    HttpClient httpClient = new HttpClient();
//    	    HttpClientParams p = new HttpClientParams();
//    	    p.setSoTimeout(120000);
//    	    p.setIntParameter("http.socket.timeout", 120000);
//    	    p.setIntParameter("http.connection.timeout", 120000);
//    	    httpClient.setParams(p);
//    	    postMethod = new UTF8PostMethod(reUrl);
//    	    if (ParamMap != null) {
//    	        NameValuePair[] postData = new NameValuePair[ParamMap.keySet().size()];
//    	        int i = 0;
...
//    	    }
//    	    String reStr = resBuffer.toString();
//    	    return reStr;
//	    }
//	    catch (Exception e) {
//	        logger.error("httpUTF8Post error.", e);
//	    } finally {
...
//    }
    ...
    public static String join(String[] strArr, String join) {
    	try {
    		StringBuffer sb = new StringBuffer();
    ...
    public static String join(int[] iArr, String join) {
    	try {
    		StringBuffer sb = new StringBuffer();
    		for (int i : iArr) {
    			if (sb.length() == 0) {
...
//    }
    ...
    public static String http(String url, String host, String agent, String parameter, boolean session, String streamCharsetName) {
        HttpURLConnection httpConnection = httpConnection(url);
        if (httpConnection == null)
            return null;
        ...
        if(!StringUtil.isEmpty(agent)){
            httpConnection.setRequestProperty("agent", agent);
        }
        return http(httpConnection, parameter, session, streamCharsetName);
    }
